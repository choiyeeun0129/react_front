...
// material-ui
import { Grid, Stack, TextField, Button, Typography, FormControl, Select, MenuItem, Modal, Tab } from '@mui/material';
...
function SlipForm() {
  ...
  //어음상세탭이 열려있는지 여부
  const [billDetailTabOpen, setBillDetailTabOpen] = useState(false);
  ...
  const searchSlip = () => {
    ...
    dispatch(types.selectSlipStart(params)); //action줄려고 dispatch
  };
  //전표 추가
  const addSlip = () => {
    if (status == '작성중') {
            ...
            >
              ...
              {billDetailTabOpen && (
                <Grid item xs={12}>
                  <MainCard title="어음상세">
                    <Box p={3}>
                      <TextField label="필드 1" />
                      <TextField label="필드 2" />
                      <TextField label="필드 3" />
                      <TextField label="필드 4" />
                      <TextField label="필드 5" />
                      <TextField label="필드 6" />
                      <TextField label="필드 7" />
                      <TextField label="필드 8" />
                      <TextField label="필드 9" />
                    </Box>
                  </MainCard>
                </Grid>
              )}
