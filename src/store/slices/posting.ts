...
//========================================= 2024-03-11 지출증빙 시작 ==============================================
export const SELECT_RECEIPT_START = 'SELECT_RECEIPT_START';
export const SELECT_RECEIPT_SUCCESS = 'SELECT_RECEIPT_SUCCESS';
export const SELECT_RECEIPT_FAILURE = 'SELECT_RECEIPT_FAILURE';

export const selectReceiptStart = createAction(SELECT_RECEIPT_START); //지출증빙조회
export const selectReceiptSuccess = createAction(SELECT_RECEIPT_SUCCESS);
export const selectReceiptFailure = createAction(SELECT_RECEIPT_FAILURE);
...
const AccountReducer = (state = initialState, action: any) => {
  ...
  switch (action.type) {
    ...
    //==================지출증빙====================
    case SELECT_RECEIPT_START:
      console.log('SELECT_RECEIPT_START');
      console.log(action);
      return {
        ...state
      };
    case SELECT_RECEIPT_SUCCESS:
      console.log('SELECT_RECEIPT_SUCCESS');
      console.log(action);
      return {
        ...state,
        receiptList: action.payload
      };
    case SELECT_RECEIPT_FAILURE:
      return {
        ...state,
        error: action.error
      };
