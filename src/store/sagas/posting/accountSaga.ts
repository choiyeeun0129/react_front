...
//==================== 지출증빙 조회 =================================================
const selectReceiptSaga = createRequestSaga(types.SELECT_RECEIPT_START, api.selectReceipt); //리듀서가 실행되기 전에 먼저 실행됨
...
export default function* accountSaga() {
  ...
  //지출증빙 조회
  yield takeEvery(types.SELECT_RECEIPT_START, selectReceiptSaga);
}
//********************************** 2021-02-24 이은기 **********************************
